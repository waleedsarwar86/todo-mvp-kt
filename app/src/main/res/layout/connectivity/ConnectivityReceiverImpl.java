...
public final class ConnectivityReceiverImpl extends BroadcastReceiver implements com.waleedsarwar.todoist.data.util.connectivity.ConnectivityReceiver {

    private static final String TAG = com.waleedsarwar.todoist.data.util.connectivity.ConnectivityReceiverImpl.class.getSimpleName();

    private static final String ACTION_CONNECTIVITY_CHANGE = "android.net.conn.CONNECTIVITY_CHANGE";

    private final com.waleedsarwar.todoist.data.util.connectivity.NetworkUtils networkUtils;
    private final Scheduler backgroundScheduler;
    private final PublishSubject<Boolean> subject;

    private boolean isConnected;

    public ConnectivityReceiverImpl(final Context context, final com.waleedsarwar.todoist.data.util.connectivity.NetworkUtils networkUtils, final Scheduler backgroundScheduler) {
